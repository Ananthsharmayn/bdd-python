@tc_24
Feature: TC_24 - Check "Apply" button functionality for Brake designer job in Hardware Department

  Scenario Outline: Verify "Apply" button functionality for Brake designer job
